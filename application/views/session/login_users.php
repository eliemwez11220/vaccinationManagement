...
<head>
    ...
    <title><?= $title ? $title : 'Bienvenue' ?> | IntrantsManagement Applicattion !</title>
                ...
                <div class="col-sm-6">
                    <div class="float-left text-left">
                        ...
                        <img src="<?= base_url(); ?>global/img/logo/coding.png"
                            ...
                            | <a href="https://congoagile.com" style="background-color: transparent; color: blue; font-weight: bold;">IntrantsManagement Application</a>
                        </span>
                    </div>
                </div>
                <div class="col-sm-6" >
                    <div class="float-right text-right" style="margin-right: 10px!important;">
                        ...
                        <span class="small" style="background-color: transparent; color: #ffffff; font-weight: bold;">
                            IntrantsManagement et son logo sont des marques déposées de
