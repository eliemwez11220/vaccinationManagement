...
<html>
    <head>
        ...
        <title><?= (!empty($title) ? $title: "dashboard"); ?> | IntrantsManagement Application</title>
        <!-- favicon
        ============================================ -->
        ...
        <div class="wrapper">
            <header class="main-header">
                ...
                <a href="" class="logo">
                    ...
                    <span class="logo-mini">IntrantsManagement</span>
                    <!-- logo for regular state and mobile devices -->
                    <span class="logo-lg">IntrantsManagement</span>
                </a>
            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
						...
						<li>
                            <a href="#">
                                <i class="fa fa-cubes"></i> <span>Intrants</span>
                            </a>
                            <ul class="treeview-menu">
								<li class="active">
                                    <a href="<?php echo site_url('intrant/add');?>"><i class="fa fa-plus"></i> Creer nouvel intrant</a>
                                </li>
								<li>
                                    <a href="<?php echo site_url('intrant/index');?>"><i class="fa fa-list-ul"></i> Listing Intrants</a>
                                </li>
							</ul>
                        </li>
						...
						<li>
                            <a href="#">
                                <i class="fa fa-arrow-circle-right"></i> <span>Entrees</span>
                            </a>
                            <ul class="treeview-menu">
								<li class="active">
                                    <a href="<?php echo site_url('entree/add');?>"><i class="fa fa-plus"></i> Creer nouvelle entree</a>
                                </li>
								<li>
                                    <a href="<?php echo site_url('entree/index');?>"><i class="fa fa-list-ul"></i> Listing Entrees</a>
                                </li>
							</ul>
                        </li>
                        ...
                        <li>
                            <a href="#">
                                <i class="fa fa-refresh"></i> <span>Demandes</span>
                            </a>
                            <ul class="treeview-menu">
                                <li class="active">
                                    <a href="<?php echo site_url('demande/add');?>"><i class="fa fa-plus"></i> Creer nouvelle demande</a>
                                </li>
                                <li>
                                    <a href="<?php echo site_url('demande/index');?>"><i class="fa fa-list-ul"></i>Listing Demandes </a>
                                </li>
						...
						<li>
                            ...
                            <ul class="treeview-menu">
								<li class="active">
                                    <a href="<?php echo site_url('user/add');?>"><i class="fa fa-plus"></i> creer un compte</a>
                                </li>
								<li>
